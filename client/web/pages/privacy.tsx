...
import * as S from "@/styles/privacy";
...
const Privacy = () => {
  return (
    <LandingPageLayout>
      ...
      <S.PrivacyWrapper>
        <h2>AIemploye Privacy Policy</h2>
        <p>
          Your privacy is important to us. It is AIemploye&#39;s policy to
          ...
          across our website,{" "}
          <a href="https://aiemploye.com">https://aiemploye.com</a>, and other
          sites we own and operate.{" "}
        </p>
        <p>
          This policy is effective as of 4 May 2023 and was last updated on 4
          May 2023.{" "}
        </p>
